...
void sr_arpcache_sweepreqs(struct sr_instance *sr);
void sr_arpcache_handle_arpreq(struct sr_instance *sr, struct sr_arpreq *request);
void sr_arpcache_send_icmp_host_unreachable(struct sr_instance *sr, struct sr_arpreq *request);
